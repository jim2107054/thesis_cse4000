  ...
  return (
    <SidebarProvider>
      <Sidebar className="admin-pos border-r border-[#E6EAED] bg-white">
        ...
        <SidebarContent>
          <SidebarGroup>
            <SidebarGroupLabel className="text-xs font-bold uppercase tracking-normal text-[#7A8086]">Admin</SidebarGroupLabel>
            <SidebarGroupContent>
              <AdminNav />
            </SidebarGroupContent>
          </SidebarGroup>
      ...
      <SidebarInset className="admin-pos min-h-screen bg-[#F9FAFB]">
        <header className="flex h-[60px] items-center gap-3 border-b border-[#E6EAED] bg-white px-6">
          ...
          <span className="text-sm font-semibold text-[#212B36]">Audit-ready labeling workspace</span>
        </header>
        {children}
      </SidebarInset>
    </SidebarProvider>
